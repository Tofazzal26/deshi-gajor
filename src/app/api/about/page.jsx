        ...
        <div className="my-10 lg:my-20">
            ...
            <div className="howCardShadow p-8">
              <div>
                ...
                <p className="text-sm lg:text-lg text-gray-500 my-2 lg:my-6 leading-[30px] lg:leading-[40px]">
                  At DeshiGajor, we believe that every opinion matters. In
                  today’s digital world, people often fall for flashy marketing
                  and paid promotions without knowing the real stories behind
                  companies and services. That’s where we come in. DeshiGajor is
                  a people-powered review platform dedicated to helping users
                  across Bangladesh share their honest experiences. Whether it’s
                  a small local business or a big corporate brand, your voice
                  can shed light on their actual performance. From great
                  customer service to unresolved complaints, every review helps
                  others make smarter, safer choices. We are committed to
                  building a trusted and transparent space where anyone—be it a
                  student, a freelancer, a shopper, or a business owner—can find
          ...
          <div className="howCardShadow p-8 mt-5 lg:mt-10">
            <p className="text-sm lg:text-lg text-gray-500 leading-[30px] lg:leading-[40px]">
              Our goal is to reduce misinformation, encourage accountability,
              and create a community where people support each other through
              shared knowledge. DeshiGajor isn’t just about stars and ratings.
              It’s about empowering users, promoting fairness, and shaping a
              more informed society. Together, we can make businesses better and
              decisions easier.
            </p>
          </div>
              ...
              <div className="howCardShadow">
                <div className="text-center lg:px-12 px-6 py-10 lg:py-20">
                  ...
                  <p className="text-gray-500 text-base lg:text-lg lg:mt-8 mt-4 mb-5 lg:mb-10 mx-auto lg:w-[600px]">
                    ...
                    We aim to connect people through shared experiences,
                    ensuring that decisions are based on truth, not trends. No
                    fake reviews — only honest conversations.
                  </p>
