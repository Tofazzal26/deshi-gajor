          ...
          <div className="flex lg:flex-row flex-col-reverse gap-5 mt-10">
            <div>
              ...
              <p className="text-gray-500 text-base lg:text-lg lg:w-[715px] mt-3 lg:mt-4">
                ...
                generation of leaders, and nurturing the potential of
                Palestinian youth, helping them develop into confident,
                informed, and compassionate individuals who can contribute to
          ...
          <div className="grid mt-10 lg:mt-20 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="howCardShadow">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 text-center">
                  ...
                  elit. Make a profound difference by contributing to the
                  construction of temporary masjids, offering spiritual solace
                  and a sacred place of prayer for displaced families.
                </p>
              </div>
            </div>
            <div className="howCardShadow">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 text-center">
                  Restoration of damaged water wells, ensuring the people of
                  Gaza receive a sustainable and reliable supply of clean water.
                  This vital initiative supports the health and well-being of
                  these resilient communities, fostering a brighter and more
                  secure future.
                </p>
              </div>
            </div>
            <div className="howCardShadow">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 text-center">
                  Donate to our food aid program, you ensure that these
                  vulnerable children receive the nourishment they need to grow
                  and thrive. This is more than just a meal, it's a message that
                  someone cares, that they are not alone in their struggles.
                </p>
              </div>
            </div>
            <div className="howCardShadow">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 text-center">
                  Water is a lifeline, yet thousands in Gaza struggle with
                  severe shortages. Your support can provide 1500 litres of
                  safe, drinkable water to families in need—offering comfort,
                  health, and hope. Every drop helps ease suffering, ensuring
                  that communities.
                </p>
              </div>
            </div>
