    ...
    <div className="bg-[#03211b] text-white">
      <div className="container mx-auto lg:px-0 px-2">
        <div className="pt-[50px]">
          <div className="flex lg:gap-0 gap-6 lg:flex-row md:flex-row flex-col items-center justify-center md:justify-between lg:justify-between">
            <div className="lg:text-start md:text-start text-center">
              ...
              <div className="flex items-center lg:justify-start md:justify-start justify-center gap-3 lg:gap-6 mt-3 lg:mt-7">
                <button
